...
from human_feedback_rl.common.gatherers import BinaryPreferenceGathererFromReward
...
class BinaryPreferenceAlgorithm(BaseRewardLearningAlgorithm):
    ...
    def __init__(
        ...
        self.preference_gatherer = BinaryPreferenceGathererFromReward(logger=self.logger)
