...
from human_feedback_rl.common import Transition, Trajectory, PrefixLoggerDagger
...
class DaggerAlgorithm():
    ...
    def __init__(
        ...
        self._bc_log = PrefixLoggerDagger(inner=self._logger, prefix="bc")
        self._dagger_log = PrefixLoggerDagger(inner=self._logger, prefix="dagger")
        self._train_log = PrefixLoggerDagger(inner=self._logger, prefix="train")
        self._eval_log = PrefixLoggerDagger(inner=self._logger, prefix="eval")
